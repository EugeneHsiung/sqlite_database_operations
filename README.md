...
6. ```# Function to remove white space and special characters from a value
...
was used to clean column names such as removing white spaces and special characters
